...
tutors = ['Иван', 'Анастасия', 'Петр', 'Сергей', 'Дмитрий', 'Борис', 'Елена', 'Жора', 'Жора', 'Жора']
klasses = ['9А', '7В', '9Б', '9В', '8Б', '10А', '10Б', '9А']

# common_list = zip(tutors, klasses)
# print(*common_list)


def check_gen(tutors: list, klasses: list):
    """ Генератор, возврачающий кортежи с парами значений из списков.
     Если список tutor>klassess, выравнивает длину последнего элементами со значением None
     """
    for _ in range(len(klasses), len(tutors)):
        klasses.append(None)
    for i in zip(tutors, klasses):
        yield i
