...
# реализовать переопределение метода draw таким образом,
# чтобы для каждого класса метод выводил в stdout только сообщение формата
# <Имя класса>: приступил к отрисовке объекта "<title>",
# при этом для класса Pencil при запуске метода draw в stdout сначала выводить сообщение Запуск отрисовки,
...
class Stationery:
    ...
    def __init__(self, title: str) -> None:
        """
                Конструктор класса
                :param title: название концелярского предмета
    ...
    def draw(self) -> None:
        """
                При вызове метода выводит сообщение
                'Запуск отрисовки'
        """
