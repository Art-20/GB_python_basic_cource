...
# если атрибут is_police равен True,
# то при вызове метода выводить в stdout дополнительно второе сообщение Вруби мигалку и забудь про скорость!;
# для классов TownCar и WorkCar переопределите метод show_speed.
# При значении скорости свыше 60 (TownCar) и 40 (WorkCar) в stdout должно выводиться сообщение о превышении скорости Alarm!!! Speed!!!,
# если превышения нет, то стандартное сообщение из родительского класса.
...
class Car:
    ...
    def go(self) -> None:
        ...
        """
        self.speed += 15
        print(f'Машина {self.name} повысила скорость на 15: {self.speed} км/ч')
    ...
    def turn(self, direction: str) -> None:
        ...
        """
        # right_direction = ['направо', 'налево', 'прямо', 'назад']
        # assert direction in right_direction, 'нераспознанное направление движения'
        # print(f'Машина {self.name}: движется {direction}')

        right_direction = ['направо', 'налево', 'прямо', 'назад']
        if direction in right_direction:
            print(f'Машина {self.name}: движется {direction}')
        else:
    ...
    def show_speed(self) -> None:
        ...
        """
        print(f'Машина {self.name}: текущая скорость {self.speed} км/час')
...
class TownCar(Car):
    def show_speed(self) -> None:
        """
        Проверка текущей скорости автомобиля
        :return: При значении скорости свыше 60 (TownCar) в stdout
        должно выводиться сообщение о превышении скорости Alarm!!! Speed!!!,
        если превышения нет, то стандартное сообщение из родительского класса.
        """
        if self.speed > 60:
            print(f'Alarm!!! Speed!!!')
...
class WorkCar(Car):
    ...
    def show_speed(self) -> None:
        """
        Проверка текущей скорости автомобиля
        :return: При значении скорости свыше 40 (WorkCar) в stdout
        должно выводиться сообщение о превышении скорости Alarm!!! Speed!!!,
        если превышения нет, то стандартное сообщение из родительского класса.
        """
...
class SportCar(Car):
    def show_info(self):
        print(f'Машина {self.name}: спорткар')
